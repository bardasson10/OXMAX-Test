// components/product-calculator.tsx
"use client"
...
export default function ProductCalculator() {
  ...
  const totalPrice = requiredKg * 20 // R$ 20 por kg

  return (
    <section className="py-2 bg-accent/5">
      {/* Container principal ajustado para max-w-7xl e padding responsivo */}
      <div className="max-w-7xl px-2 sm:px-4 lg:px-8 mx-auto"> 
        ...
        {/* NOVO WRAPPER: Limita a largura em telas menores para corrigir o layout lateral */}
